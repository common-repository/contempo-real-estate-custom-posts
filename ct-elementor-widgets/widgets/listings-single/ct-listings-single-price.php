 ...
 * @since 1.0.0
 */
class CT_Listings_Single_Price extends Widget_Base {
	...
	public function get_name() {
		return 'ct-listings-single-price';
	}
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ct-elementor-listings-single-price' => 'text-align: {{VALUE}}',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .ct-elementor-listings-single-price',
					'fields_options' => [
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ct-elementor-listings-single-price' => 'color: {{VALUE}}',
					],
					'default' => '#121212',
				]
			);
	...
	protected function render() {
		...
		echo '<div class="ct-elementor-listings-single">';
			echo '<' . $settings['html_tag'] . ' class="ct-elementor-listings-single-price">';
