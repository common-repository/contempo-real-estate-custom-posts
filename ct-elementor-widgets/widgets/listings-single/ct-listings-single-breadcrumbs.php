 ...
 * @since 1.0.0
 */
class CT_Listings_Single_Breadcrumbs extends Widget_Base {
	...
	public function get_name() {
		return 'ct-listings-single-breadcrumbs';
	}
	...
	public function get_title() {
		return __( 'CT Breadcrumbs', 'contempo' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ct-elementor-listings-single-breadcrumbs' => 'text-align: {{VALUE}}',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .ct-elementor-listings-single-breadcrumbs',
					'fields_options' => [
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ct-elementor-listings-single-breadcrumbs' => 'color: {{VALUE}}',
	...
	protected function render() {
		...
		echo '<div class="ct-elementor-listings-single">';
			//echo ct_return_elementor_id();
			echo '<' . $settings['html_tag'] . ' class="ct-elementor-listings-single-breadcrumbs breadcrumb">';
